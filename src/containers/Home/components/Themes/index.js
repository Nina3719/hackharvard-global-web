    ...
    return (
      <Wrapper flexDirection="column" width={["100%", "100%", "1000px"]}>
        ...
        <Section flexDirection={["column-reverse", "row", "row"]}>
          <Left width={["95%", "50%", "50%"]} m="auto" background={true}>
            <Points>
              <b>1. Primary education - </b>
          ...
          <Right width={["95%", "50%", "50%"]} m="auto">
            ...
            >
              ...
              Educational technologies [insert photo]
            </Text>
          </Right>
        </Section>
        <Section flexDirection={["column", "row", "row"]}>
          <Left width={["95%", "50%", "50%"]} m="auto">
            ...
            >
              ...
              Environmental technologies [insert photo]
            </Text>
          </Left>
          <Right width={["95%", "50%", "50%"]} m="auto" background={true}>
            <Points>
              <b> 1. Full stream recycling/reuse (physical materials) - </b>
            ...
            <Points>
              <b>
                2. Efficiency of transportation/lifestyle (energy conservation)
                -
              </b>
            ...
            <Points>
              <b>
                3. Deforestation/environmental destruction of forests/dams -
              </b>
            ...
            <Points>
              <b> 4. Smog and air quality - </b>
              how to improve it? How to protect people from its effects?
            </Points>

            <Points>
              <b> 5. Awareness of local environmental implications -</b> how can
              we educate people on the environmental changes around them?
            </Points>
        ...
        <Section flexDirection={["column-reverse", "row", "row"]}>
          <Left width={["95%", "50%", "50%"]} m="auto" background={true}>
            <Points>
              <b>
                1. Care for the elderly from a emotional/social perspective -
              </b>
            ...
            <Points>
              <b> 2. Care for the elderly from a health perspective - </b>
              how do we monitor the health of the elderly and ensure they are
              watched over?
            </Points>

            <Points>
              <b> 3. Communication methods/accessible technologies - </b>
            ...
            <Points>
              <b> 4. Work/livelihood for the elderly - </b> How can we
          ...
          <Right width={["95%", "50%", "50%"]} m="auto">
            ...
            >
              ...
              Technologies for the elderly [insert Photo]
            </Text>
          </Right>
        </Section>
      </Wrapper>
